...
export const reportSections: ReportSection[] = [
  ...
  },
  {
    ...
    offre: 'gratuit',
    fixedText:
      'Ce pré-diagnostic applique l’état de l’art à vos familles de métiers à partir d’un socle de sources de référence (ILO, Stanford AI Index, MIT, OCDE, WEF, CIANum, Indeed, PwC, McKinsey), complété d’une couche France (Parlons RH, CEGOS, Neobrain × Sopra Steria, France Stratégie/DARES). Points de méthode. Chaque affirmation reste rattachée à sa source, à son type (recherche ou commercial) et à son horizon. On distingue exposition et suppression, l’augmentation domine. Le mapping des métiers vers la classification ISCO s’appuie sur un niveau de confiance corrigeable. Certaines données mondiales ou américaines ne sont pas directement transposables à une PME française et sont signalées comme telles. Socle daté 2023-2026, versionné. Ce document est indicatif et ne constitue pas un diagnostic individuel.',
  },
];
