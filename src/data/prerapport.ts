...
export const preRapport = {
  intro: {
    eyebrow: 'Pré-diagnostic · offert',
    title: 'Cartographiez l’impact de l’IA sur les métiers de votre secteur.',
    sub: 'En quelques minutes, MIRA croise ce que vous nous décrivez avec les grands rapports de référence (World Economic Forum, OCDE, baromètres RH…) pour produire votre pré-diagnostic sectoriel. Sans engagement.',
    points: [
      ...
      { t: 'Confidentiel', d: 'Vos réponses ne servent qu’à générer votre pré-diagnostic.' },
    ],
  ...
  fields: {
    ...
    telephone: {
      ...
      hint: 'Optionnel. Uniquement pour échanger sur votre pré-diagnostic si vous le souhaitez.',
    },
    email: {
  ...
  success: {
    ...
    body: 'Nous générons votre pré-diagnostic sectoriel et vous l’envoyons en PDF par email d’ici 1 à 2 minutes. Pensez à vérifier vos courriers indésirables.',
