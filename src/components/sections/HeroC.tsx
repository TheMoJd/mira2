...
export default function HeroC() {
  ...
  return (
    <section id="top" style={{ position: 'relative', paddingTop: 168, paddingBottom: 70, overflow: 'hidden', textAlign: 'center' }}>
      <motion.div
        style={{
          position: 'absolute', top: 80, left: '50%', x: '-50%',
          width: 760, height: 520,
          background: 'radial-gradient(circle, rgba(106,69,255,.14), transparent 62%)',
          filter: 'blur(30px)', y: yWord,
        }}
      />
      ...
      <div className="wrap" style={{ position: 'relative', maxWidth: 1000 }}>
        ...
        >
          <span style={{ width: 26, height: 1, background: 'var(--violet)', display: 'block' }} />
        ...
        <h1 className="display" style={{ fontSize: 'clamp(44px,6.6vw,92px)', margin: '0 auto 30px', lineHeight: 0.98, maxWidth: 980 }}>
          <motion.span style={{ display: 'block' }} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}>
            L'IA redessine la carte
          </motion.span>
          <motion.span style={{ display: 'block' }} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.12, ease: [0.22, 1, 0.36, 1] }}>
            des compétences.
          </motion.span>
          <motion.span className="italic grad" style={{ display: 'block' }} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.26, ease: [0.22, 1, 0.36, 1] }}>
            MIRA donne la boussole.
          </motion.span>
        </h1>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}
          ...
          <Button href="#methode">Lire la méthode</Button>
        </motion.div>
