...
export default function Diff() {
  return (
    <section id="produit" style={{ padding: '0 0 110px' }}>
      <div className="wrap">
        <Head kicker="Ce qui nous distingue" title="MIRA renforce votre orientation." sub="Un accompagnement sur-mesure, une conformité native et un effet de réseau qui se renforce vague après vague." center max={620} />
