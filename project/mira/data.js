/* ============================================================
   MIRA — Content (FR). Plain global object: window.MIRA
   ============================================================ */
window.MIRA = {
  brand: {
    name: "MIRA",
  ...
  /* métiers pour la matrice d'exposition (exposure 0-100, opportunity 0-100) */
...
/* Shared globals for cross-file babel scripts (scopes are isolated). */
window.D = window.MIRA;
if (window.Motion) {
